...
public final class MathildeMortalitySubModule extends ModelBasedSimulator {
	
	double errorTotalVariance;
	
	public MathildeMortalitySubModule(boolean isParametersVariabilityEnabled, boolean isRandomEffectVariabilityEnabled, boolean isResidualVariabilityEnabled) {
