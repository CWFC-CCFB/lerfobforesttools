...
public class CATFrame extends REpiceaFrame implements PropertyChangeListener, ItemListener,
	...
	public static enum MessageID implements TextableEnum {
		...
		ParametersAreInvalid("The flux configuration in the flux manager is invalid. Please carefully check for inconsistent fluxes or endless loops!",
				"La configuration des flux est incoh\u00E9rente. Veuillez v\u00E9rifier la pr\u00E9sence de flux incoh\u00E9rent et de boucles sans fin!"),
