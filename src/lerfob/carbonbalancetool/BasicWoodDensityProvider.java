...
public interface BasicWoodDensityProvider {
	...
	public enum AverageBasicDensity {
		...
		AverageBasicDensity(double density, double moistureContent) {
			this.basicDensityGreen = density / ((1d + 0.01* moistureContent) * (CGV * 0.01 * (30d - moistureContent) + 1));	// eq2.5 in Guilley, E. 2000. La densité du bois du chêne sessile. Thèse ENGREF.
		}
