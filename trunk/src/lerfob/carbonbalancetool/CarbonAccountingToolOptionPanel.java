 ...
 */
public class CarbonAccountingToolOptionPanel extends JScrollPane implements ItemListener {
	
	private static final long serialVersionUID = 1L;
	private List<CarbonAccountingToolCompartmentCheckBox> booleanSettings;

	public CarbonAccountingToolOptionPanel() {
		booleanSettings = new ArrayList<CarbonAccountingToolCompartmentCheckBox>();
	...
	private JPanel getCheckBoxPanel(CompartmentInfo compartmentID, boolean offset) {
		...
		CarbonAccountingToolCompartmentCheckBox checkBox = new CarbonAccountingToolCompartmentCheckBox(compartmentID);
	...
	protected List<CompartmentInfo> getCompartmentToBeShown() {
		...
		for (CarbonAccountingToolCompartmentCheckBox chkBox : booleanSettings) {
