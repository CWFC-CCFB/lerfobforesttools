...
public class FrenchHDRelationship2018TreeImplForTest extends FrenchHDRelationship2018TreeImpl {
	...
	FrenchHDRelationship2018TreeImplForTest(int id, double heightM, double dbhCm, double gOther, String speciesName, double weight, double pred, FrenchHDRelationship2018PlotImpl plot) {
