...
public class ValidationOn2013Data {
	...
	static Map<Integer, Map<Integer, FrenchHDRelationship2018StandImpl>> StandMap;
...
//				double pred;
				...
				while ((record = reader.nextRecord()) != null) {
					...
					new FrenchHDRelationship2018TreeImpl(-1, d130, gOther, species, htot, innerMap.get(idp));
	...
	public void validateWithTheNumberOfKnownHeightsPerPlot(int i) throws IOException {
		...
		Map<Integer, FrenchHDRelationship2018StandImpl> stands = StandMap.get(2013);
		for (FrenchHDRelationship2018StandImpl stand : stands.values()) {
			stand.clear();
